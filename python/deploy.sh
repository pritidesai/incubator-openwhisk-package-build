...
# Setup environment
# read openwhisk action name, action zip file, and docker image from CLI
...
# set these variables to defaults if not set on CLI
OPENWHISK_ACTION_NAME=${OPENWHISK_ACTION_NAME:="python-build"}
OPENWHISK_ACTION_DOCKER_IMAGE=${OPENWHISK_ACTION_DOCKER_IMAGE:="openwhisk/python2action"}
